...
Plans:
- [x] 02-01-PLAN.md — Create release.yaml and pr-title.yaml workflows
- [x] 02-02-PLAN.md — End-to-end release validation (feat: commit, tag, GitHub Release, Wiki)
- [x] 02-03-PLAN.md — QUAL-06 gap closure: demonstrate pr-title.yaml rejection with conclusion=failure
...
| REL-01 | 2 | 3/3 | Complete   | 2026-03-03 | 2 | `fetch-depth: 0` and permissions |
